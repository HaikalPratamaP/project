...
<div class="content-wrapper">
    ...
    <div class="row mt-3">
      <div class="col-lg-6">
         <div class="card">
           <div class="card-body">
           <div class="card-title">Tambah Data position</div>
           <hr>
            <form action="/position/simpan" method="POST">
                @csrf
           <div class="form-group">
            <label for="input-1">Nama jabatan</label>
            <input type="text" class="form-control" id="input-1" placeholder="Enter Your nama_jabatan" name="nama_jabatan" required>
           </div>
           <div class="form-group">
