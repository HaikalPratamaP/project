      ...
      <div class="col-lg-6">
         <div class="card">
           ...
           <div class="form-group">
            ...
            <input type="number" value="{{$ticket->no_ticket}}" class="form-control" id="input-1" placeholder="Enter Your No_ticket" name="no_tiket" required>
           </div>
           <div class="form-group">
